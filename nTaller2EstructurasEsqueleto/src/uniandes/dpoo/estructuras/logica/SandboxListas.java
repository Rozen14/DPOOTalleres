...
public class SandboxListas
{
    ...
    {
    	List<Integer> nuevoArreglo = new ArrayList<Integer>();
    	for (int num : listaEnteros) {
    		nuevoArreglo.add(num);
    	}
        return nuevoArreglo;
    }
    ...
    {
    	List<String> nuevoArreglo = new LinkedList<String>();
    	for (String str : listaCadenas) {
    		nuevoArreglo.add(str);
    	}
        return nuevoArreglo;
    }
    ...
    {
    	listaEnteros.removeIf(num -> num == valor);
    }
    ...
    {
    	listaCadenas.removeIf(String -> String == cadena);
    }
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for (String str : listaCadenas) {
            if (str.toLowerCase().equals(cadenaMinuscula)) {
                conteo++;
            }
        }
        return conteo;

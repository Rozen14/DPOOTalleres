...
public class SandboxArreglos
{
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        int index = 0;
        for (String cad: nuevoArreglo) {
            if (cad != cadena) {
                nuevoArreglo[index++] = cadena;
            }
        }
        arregloCadenas = nuevoArreglo;
    }
    ...
    public void organizarCadenas( )
    {
        ...
        do {
            intercambiado = false;
            for (int i = 1; i < n; i++) {
                if (arregloCadenas[i - 1].compareTo(arregloCadenas[i]) > 0) {
                    String temp = arregloCadenas[i - 1];
                    arregloCadenas[i - 1] = arregloCadenas[i];
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for (String str : arregloCadenas) {
            if (str != null && str.toLowerCase().equals(cadenaMinusc)) {
                contador++;
            }
        }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        for (int valor : otroArreglo) {
            frecuenciaOtro.put(valor, frecuenciaOtro.getOrDefault(valor, 0) + 1);
        }
    ...
    {
    	if (arregloEnteros == null || arregloEnteros.length != cantidad) {

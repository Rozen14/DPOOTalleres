...
public class SandboxMapas
{
    ...
    {
    	return mapaCadenas.keySet().stream().sorted()
    			.toList().reversed(); 
    }
    ...
    {
    	Map<String, Boolean> conteoValores = new HashMap<>();
        Collection<String> valores = mapaCadenas.values();
        for (String valor : valores) {
            conteoValores.put(valor, true);
        }
        return conteoValores.size();
    }
    ...
    public void volverMayusculas( )
    {
         ...
         for (Map.Entry<String, String> entrada : mapaCadenas.entrySet()) {
             ...
             nuevoMapa.put(llaveMayusculas, entrada.getValue());
         }
    ...
    public boolean compararValores( String[] otroArreglo )
    {
        ...
        for (String cadena : otroArreglo) {
            ...
            for (String valor : valoresDelMapa) {
